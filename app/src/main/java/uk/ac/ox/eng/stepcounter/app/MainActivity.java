...
import uk.ac.ox.eng.stepcounter.app.lib.StepCounter;
...
//    private final int INSHOW_SAMPLING_FREQUENCY = 25;
    ...
    private final int COLOR_TITLE = R.color.colorAccent;
    private final int COLOR_CONTENT = R.color.colorPrimary;
    private final int COLOR_UNIT = R.color.colorPrimaryDark;
    private final int COLOR_RED = R.color.xx;
    ...
    private View.OnClickListener startClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (isEnabled) {
                ...
                if (hwstepsCounter != null)
                    sensorManager.registerListener(hwStepsEventListener, hwstepsCounter, SensorManager.SENSOR_DELAY_NORMAL);
            }
        }
    };
